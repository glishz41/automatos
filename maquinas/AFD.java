...
public class AFD {
    Integer estadosFinais[], estadoInicial, estadoAtual;
    String dados[], type = "F";
    Patterns patterns[];

    public AFD(String[] specs, String[] input) {
    ...
    //faz o papel da função de trnasição
    ...
    //método de verificação de estado final
